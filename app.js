...
app.get('/twiml', function(req, res) {
  ...
  switch(req.query.Body) {
    ...
    case 'Where is the nearest hospital?':
      var message = "The nearest open hospital is MedStar Union Memorial Hospital at 201 E. University Pkwy, Baltimore, MD 21218, USA. Good luck! 🔥 Would you like me to schedule an appointment?";
      res.set('Content-Type', 'text/xml');
      res.send(o2x({
          '?xml version="1.0" encoding="utf-8"?' : null,
          Response: {
